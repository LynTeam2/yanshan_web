            ...
            <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="答案">
                    <el-checkbox-group
                            ...
                            :min="1"
                            :max="4">
                        <el-checkbox label="choiceA">选项A</el-checkbox>
                        <el-checkbox label="choiceB">选项B</el-checkbox>
                        <el-checkbox label="choiceC">选项C</el-checkbox>
                        <el-checkbox label="choiceD">选项D</el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
...
<script>
    ...
    import { getQuestionListPage, removeQuestion, batchRemoveQuestion, editMultipleChoice, addMultipleChoice } from '../../api/api';
        ...
        methods: {
            ...
            handleDel: function (index, row) {
                this.$confirm('确认删除该记录吗?', '提示', {
                    ...
                    this.listLoading = true;
                    //NProgress.start();
                    let para = { id: row.id , questionType: 'mc'};
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            editMultipleChoice(para).then((res) => {
...
//							para.birth = (!para.birth || para.birth == '') ? '' : util.formatDate.format(new Date(para.birth), 'yyyy-MM-dd');
                            addMultipleChoice(para).then((res) => {
            ...
            batchRemove: function () {
                ...
                this.$confirm('确认删除选中记录吗？', '提示', {
                    ...
                    this.listLoading = true;
                    //NProgress.start();
                    let para = { id: ids, questionType: 'mc' };
